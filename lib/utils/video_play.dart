  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
            backgroundColor: Color.fromARGB(255, 2, 114, 66),
            ...
            onPressed: () async {
              ...
              bool result2 = (await Permission.storage.request().isGranted);
              print("result2");
              print(result2);
              print("result2");

              if (!Directory('/storage/emulated/0/whatsapp_status_saver')
                  .existsSync()) {
              ...
              final newFileName =
                  '/storage/emulated/0/whatsapp_status_saver/VIDEO-$curDate.mp4';
              File newFile = await originalVideoFile.copy(newFileName);
              await FolderFileSaver.saveFileToFolderExt(
                newFileName,
                removeOriginFile: false,
              );
              _onLoading(
                false,
